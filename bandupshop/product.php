                    ...
                    <ul id="trickMenu">
                        ...
                        <li>
                            ...
                            <input type="checkbox" id="menu-toggle3" style="display:none;" />
                                    <ul id="trickMenu3">
                                        <li><a href="/bandupshop/">CD</a></li>
                                        <li><a href="/bandupshop/">LP</a></li>
                                        <li><a href="/bandupshop/">Cassette</a></li>
                                        <li><a href="/bandupshop/">Boxset</a></li>
                                    </ul>
                        </li>
                ...
                ?>
                        <ul id="carritoMenu" class="items">
                            ...
                            <li>
                                ...
                                <a href="/bandupshop/product.php?action=ver&id=<?php echo $item["id"]; ?>"><?php echo "<b>" . str_replace("`", "'", $item["name"]) . "</b> por <b>" . $item["artist"] . "</b><br> Tipo: <b>" . $item["type"] ."</b><br> Cantidad: <b>" . $item["qty"] ."</b>"; ?></a>                            </div>
                            </li>
                            <?php }?>
                            <li><a>Subtotal: <b><?php echo 'MX$'.$cart->total(); ?></b></a></li>
                            <li><a href="/bandupshop/checkout.php"><b>></b> Ver carrito</a></li>
                            <?php }else{ ?>
